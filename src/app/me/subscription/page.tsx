...
const features = [
  {
    ...
    description: "Get personalized daily and weekly meal plans generated by advanced AI, tailored to your exact preferences and needs",
  },
  {
    icon: ChefHat,
    title: "Smart Recipe Generation",
    description: "Receive detailed recipes with ingredients and instructions, perfectly matched to your dietary requirements",
  },
  {
    icon: Target,
    title: "Personalized Nutrition",
    description: "Plans adapted to your body metrics, goals, dietary restrictions, and food preferences",
  },
  {
    icon: BarChart3,
...
const testimonials = [
  {
    ...
    content: "This AI meal planner has completely transformed my approach to nutrition. I've lost 15 pounds while enjoying every meal!",
    image: "https://randomuser.me/api/portraits/women/1.jpg",
  },
  {
    name: "Michael R.",
    role: "Busy Professional",
    content: "The time I save on meal planning is incredible. Plus, the recipes are delicious and fit perfectly with my workout routine.",
    image: "https://randomuser.me/api/portraits/men/1.jpg",
  },
  {
    name: "Emma L.",
    role: "Health Coach",
    content: "I recommend this to all my clients. The AI-powered customization is unlike anything I've seen before.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        ...
        >
          ...
          <p className="mt-6 text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto">
            Join thousands of happy customers who have transformed their lives with
            our AI-powered personalized nutrition platform.
          </p>
        </motion.div>
