...
async function updateUserSubscription(customerEmail: string, isNewSubscription: boolean) {
	try {
		...
		if (currentUserError || !currentUser) {
			console.error("Error fetching current user:", currentUserError || "User not found");
			return;
		}
